...
const PAGES = {
    ...
    profile_editor: [
        { sel: '#editor-title-display', title: 'Profile name', tip: 'Tap the title to rename the profile. Renaming and saving creates a copy instead of overwriting.', right: true },
        { sel: '#pe-step-list', title: 'Steps', tip: 'The shot runs top to bottom. Tap a step to edit it; the selected step also shows buttons to move, duplicate or delete it.' },
        { sel: '#pe-add-step', title: 'Add a step', tip: 'Pick what the new step should do (preinfusion, rise, hold…). Everything stays editable afterwards.' },
        { sel: '#pe-step-editor', title: 'Step settings', tip: 'Everything about the selected step: water temperature, what the pump holds, and what ends the step.' },
        { sel: '#pe-graph', title: 'Live preview', tip: 'The whole profile as the machine will run it. The shaded band is the step you are editing.' },
        { sel: '#pe-stats', title: 'At a glance', tip: 'Number of steps, roughly how long the shot takes, and what finally stops it.' },
        { sel: '#pe-shot-settings', title: 'Whole shot', tip: 'Settings that apply to the entire profile rather than one step. Advanced holds the limiter tolerances.' },
        { sel: '#editor-history-btn', title: 'Version history', tip: 'Restore an earlier saved version of this profile.' },
...
function currentPage() {
    ...
    if (onSubpage) {
        if (document.getElementById('pe-root')) return 'profile_editor';
