...
// Confirm runs several awaits deep; a second tap during them would start a
// parallel send, and selectedProfileKey can change under it (the list stays
// live). Guard the whole run and pin the key it started with.
