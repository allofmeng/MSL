...
// setWaterLevelWarning lived here: it POSTed to /de1/waterLevels, a path gone
// since the machine-namespace rename, carrying a warningThresholdPercentage the
// WaterLevels schema has no field for. No callers, so nothing noticed. Use
// api.js setWaterLevels(refillLevel) -- the only supported write to this endpoint.
