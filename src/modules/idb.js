...
export function setSetting(key, value) {
    return new Promise((resolve, reject) => {
        ...
        // Resolve on commit, not on request success: a put can succeed into a
        // transaction that never commits (the WebView is unloaded first), and the
        // caller would have been told the write landed.
