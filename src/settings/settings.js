...
export function renderFirmwareUpdateSettings() {
    ...
    // on the same page as the Upload button (Machine Info also shows it).
...
export async function initializeSettings() {
    ...
    window.submitFeedback = async function() {
        ...
        // No contact email and no machine serial: this goes into a PUBLIC GitHub
        // issue. The email used to be XOR'd with a hardcoded key, which is
        // obfuscation, not protection -- anyone reading the issue could undo it.
